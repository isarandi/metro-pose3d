...
def random_erase(im, area_factor_low, area_factor_high, aspect_low, aspect_high, rng, inplace=True):
    ...
    image_area = FLAGS.proc_side ** 2 * 0.8

    while True:
        occluder_area = rng.uniform(area_factor_low, area_factor_high) * image_area
